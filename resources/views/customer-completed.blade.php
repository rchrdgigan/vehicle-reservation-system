...
<div class="content">
    <div class="page-header">
        <div class="page-title">
            <h4>Customer Completed List</h4>
            <h6>View completed booking</h6>
        </div>
    </div>
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table datanew">
                    ...
                    <tbody>
                        @foreach($books->where('status','Completed')->where('owner_id',auth()->user()->owner->id) as $book)
                        <tr>
                            <td>
                            ...
                            <td><a class="bg-success text-white rounded">Completed</a></td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
