    ...
    <div class="sidebar-inner slimscroll">
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                ...
                <li class="{{(request()->routeIs('admin.history.booking.list'))? 'active' : ''}}"><a href="{{route('admin.history.booking.list')}}"><i class="me-2" data-feather="file-text"></i><span>Booking History</span></a></li>
                
                <li class="{{(request()->routeIs('admin.contact.list'))? 'active' : ''}}"><a href="{{route('admin.contact.list')}}"><i class="me-2" data-feather="mail"></i>
