            ...
            <form action="{{route('admin.vehicle.store')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="form-group">
                            ...
                            <div class="input-groupicon">
                                <input type="date" class="form-control" name="vehicle_exp" required>
                                @error('vehicle_exp')
                                    <strong class="text-danger">{{ $message }}</strong>
                                @enderror
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="select2" name="owner_id" required>
                                @foreach($owners as $owner)
                                    <option value="{{ $owner->id }}">{{ $owner->owner_fname. " " .$owner->owner_lname }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-2 col-sm-6 col-12">
                        <div class="form-group">
                            <label>Seater</label>
                            <input type="text" name="seating_cap" required>
                            @error('seating_cap')
